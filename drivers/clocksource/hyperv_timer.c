 ...
 * Linux stays in periodic timer mode for a short while before it switches
 * the timer to the on-demand tickless mode; in the periodic timer mode,
 * Linux timer interrupt handler reprograms the timer before the handler
 ...
 * and hence does not suffer from the rare time interrupt storm.
 */
